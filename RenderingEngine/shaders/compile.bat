...
"C:\Program Files (x86)\Windows Kits\10\bin\10.0.22621.0\x64\fxc.exe" /nologo /E ps_lightingPass /T ps_5_0 /Fo pixel_shader_deferred_lighting.bin deferredRenderingLighting.hlsl
